  ...
  _createClass(MameNasito, [{
    ...
    value: function componentWillMount() {
      ...
      client.fetch("\n      * | [ _type == \"galerie\" && slug.current == \"mame-nasito\"]| {\n        _id,\n        title,\n        description,\n        content,\n      }").then(function (res) {
        _this2.setState({
          ...
          pageDescription: res[0].description[0].children
        });

        console.log(res[0].description[0].children);
      }).catch(function (err) {
    ...
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        ...
        blocks: this.state.pageDescription,
        __source: {
          fileName: _jsxFileName,
          lineNumber: 243
        },
...
//# sourceMappingURL=mame-nasito.js.5dc19a4f353bab99280e.hot-update.js.map